...
export default function SignUp() {
  ...
  return (
    <div className="flex min-h-screen w-full px-6 flex-col items-start gap-6 bg-gradient-to-br from-[#8C99FA] via-[#5C59F3] to-[#94C1FF] overflow-hidden">
      ...
      {/* Form fields */}
      <div className="flex flex-col items-start gap-2.5 w-full max-w-4xl mx-auto px-4">
        <FormField
          label="First name"
      ...
      <div className="flex p-2.5 pb-5 flex-col items-center gap-[15px] flex-1 self-stretch">
        <div className="self-stretch text-[#0C0A66] font-montserrat text-[20px] font-normal leading-[125%] text-center">
          <span>By clicking on the sign in button, you consent to the </span>
          <button
